...
import com.cachecats.meituan.widget.HomedeliverView;
...
public class HomeFragment extends BaseFragment implements HomeFragmentContract.View {
 ...
 /*   @BindView(R.id.ll_big_module_fragment_home)
    ...
    //小模块GridView布局
    @BindView(R.id.home_deli_view)
    HomedeliverView homedeliView;
    //4块广告封装成的自定义View
...
//        mShopListAdapter.setEmptyView();
    ...
    private void initLittleModuleRecyclerView() {
        ...
        homedeliView.setOnAdsClickListener(new HomedeliverView.OnAdsClickListener() {
            @Override
            public void onAds1Click() {
                ToastUtils.show("deliver");
            }
